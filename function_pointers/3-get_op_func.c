 ...
 *               function to perform the operation asked by the user. You're
 ...
 *               You are not allowed to use more than one if statement in your
 *               code
 *               You are not allowed to use more than one while loop in your
 *               code
 ...
 *                   int i;
 *
 * Return:       a function pointer based on s or NULL
 *
 */
